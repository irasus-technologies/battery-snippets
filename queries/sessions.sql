-- FUNCTION: transactions_packs.session_individual_pack ( bigint, timestamp with time zone, timestamp with time zone)
...
BEGIN
	...
	time_points[1] = time_arr[1];  --- end time for first session
